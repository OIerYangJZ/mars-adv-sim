"""Deterministic agents that compile GoalSpec into a replayable dynamic TaskGraph."""
...
class DecompositionAgent:
    ...
    def run(self, specification: LongTaskInput) -> tuple[dict[str, DAGNode], dict[str, Any]]:
        ...
        if not work_items:
            ...
            # NEED_CLARIFICATION and refuse Coordinator export.
        ...
        for index, item in enumerate(work_items):
            ...
            nodes[task_id] = DAGNode(
                ...
                agent_role=str(metadata.get("agent_role") or "execution_agent"),
        ...
        for index, item in enumerate(specification.acceptance_conditions):
            ...
            nodes[task_id] = DAGNode(
                ...
                agent_role=str(metadata.get("verifier_role") or "validation_agent"),

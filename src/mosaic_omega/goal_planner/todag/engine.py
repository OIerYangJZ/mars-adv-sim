...
class ToDAGEngine:
    ...
    def coordinator_plan(self) -> list[dict[str, Any]]:
        ...
        if snapshot.get("status") == "needs_clarification":
            raise RuntimeError("GoalSpec needs clarification before Coordinator export")
        ...
        for node in snapshot["nodes"]:
            ...
            plan.append(
                {
                    # Existing Coordinator contract is preserved.
                    ...
                    "placement": placement,
                    # Rich information is carried in metadata; old consumers can ignore it.
                    "metadata": {

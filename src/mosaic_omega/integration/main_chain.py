...
MessageTopology + Memory Context -> Agent/ToolRuntime -> Evidence/Verification ->
Memory event sync -> final Evidence Manifest.
...
from ..runtime.edge_cloud import ExecutionTier
from ..runtime.message_topology import MessageTopologyService
from ..runtime.models import AgentProfile
from ..runtime.task_messages import ConstraintDelta, DeltaOperation, EvidenceRef, FactDelta, TaskMessage
from ..runtime.trace_context import TRACE_CONTEXTS, business_content_hash
